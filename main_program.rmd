...
# loading some pakages
#library(xlsx) # loading the library pakage to import excel files

# install.packages(c("ggplot2","dplyr","GGally","plotly","AID","MASS","boxcoxmix","car","moments",
#                    "leaps","devtools","catools","readxl","class","ROCR","qwraps2","knitr","e1071","glmnet","gam","splines","akima"))


library(ggplot2) # plotting the dataset
library(dplyr) # manupulating the dataframe
library(GGally)# scatter matrix plot
library(plotly)# plotting pakage
library(AID) # pakagef for box cox tranformation
library(MASS) # general stats pakage
library(boxcoxmix) # for boxcox tranformation
library(car)
library(moments)
library(leaps)
library(devtools)
library(caTools)
library(readxl) # loading the library pakage to import excel files
library(dplyr)# pakage for data manipulation
library(class)
library(ROCR) # pakage for ROC and AUC for classification
library(qwraps2) #
library(knitr) # for formating R-Markdown
library(e1071) # pakage for SVM
library(glmnet)# lasso and ridge regression
library(gam) # package for generalized additive model
library(splines) # package for fitting regression splines
library(akima) # akima
...
raw.data = read_excel("C:/Users/amitgajurel/Google Drive/Thesis/Data/Australian Soils.xlsx",sheet = "all_soils") # loading the dataframe from the file that user chooses from the sheet name collection_ready
...
raw.data.montana = read_excel("C:/Users/amitgajurel/Google Drive/Thesis/Data/Australian Soils.xlsx",sheet = "montana_soils") # loading the dataframe from the file that user chooses from the sheet name collection_ready
...
```{r plot for lime,cement,asphalt , fig.width= 2.5, fig.height= 3}
#binwidth = 50
...
```{r optimizing value of nearest neighbour,fig.height=4, fig.width=10}
